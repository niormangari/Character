    ...
    <div className="">
      <Container className="p-3">
        ...
        <Row className="">
          ...
          <Col md={4} className="p-2 ">
            <Card className="imagee bg-dark text-white me-2 ">
              <Image src={Zoro} alt="zoro" className="images" />
          ...
          <Col md={4} className="p-2 ">
            <Card className="imagee bg-dark text-white  me-2 ">
              <Image src={Sanji} alt="sanji" className="images" />
          ...
          <Col md={4} className="p-2 ">
            <Card className="imagee bg-dark text-white  me-2 ">
              <Image src={Usop} alt="usop" className="images" />
          ...
          <Col md={4} className=" p-2">
            <Card className="imagee bg-dark text-white  me-2 ">
              <Image src={Jinbei} alt="jinbei" className="images" />
          ...
          <Col md={4} className="p-2    ">
            <Card className="imagee bg-dark text-white  me-2 ">
              <Image src={Chopper} alt="chopper" className="images" />
